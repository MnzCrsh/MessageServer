...
public static class OwnerManagementExtension
{
    ...
    /// 
    /// </summary>
    /// <param name="ownerRepo">Concrete repository</param>
    /// <param name="existingPet">Existing pet to add</param>
    /// <param name="existingOwner">Existing owner to who pet will be added</param>
    public static void AddPet(this OwnerRepository ownerRepo, Owner existingOwner, Pet existingPet)
    {
    ...
    public static void RemovePet(this OwnerRepository ownerRepo, Owner existingOwner, Pet existingPet)
    {
